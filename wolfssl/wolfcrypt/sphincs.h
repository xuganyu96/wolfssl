...
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/api.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-192f-simple/clean/api.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-192s-simple/clean/api.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-256f-simple/clean/api.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-256s-simple/clean/api.h>
#endif /* ifdef HAVE_LIBOQS */
...
#define SPHINCS_FAST_LEVEL1_SIG_SIZE PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_BYTES
#define SPHINCS_FAST_LEVEL3_SIG_SIZE PQCLEAN_SPHINCSSHAKE192FSIMPLE_CLEAN_CRYPTO_BYTES
#define SPHINCS_FAST_LEVEL5_SIG_SIZE PQCLEAN_SPHINCSSHAKE256FSIMPLE_CLEAN_CRYPTO_BYTES
#define SPHINCS_SMALL_LEVEL1_SIG_SIZE PQCLEAN_SPHINCSSHAKE128SSIMPLE_CLEAN_CRYPTO_BYTES
#define SPHINCS_SMALL_LEVEL3_SIG_SIZE PQCLEAN_SPHINCSSHAKE192SSIMPLE_CLEAN_CRYPTO_BYTES
#define SPHINCS_SMALL_LEVEL5_SIG_SIZE PQCLEAN_SPHINCSSHAKE256SSIMPLE_CLEAN_CRYPTO_BYTES

#define SPHINCS_LEVEL1_KEY_SIZE PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_SECRETKEYBYTES
#define SPHINCS_LEVEL1_PUB_KEY_SIZE PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES
#define SPHINCS_LEVEL1_PRV_KEY_SIZE (SPHINCS_LEVEL1_PUB_KEY_SIZE + SPHINCS_LEVEL1_KEY_SIZE)
#define SPHINCS_LEVEL1_SEED_SIZE PQCLEAN_SPHINCSSHAKE128FSIMPLE_CLEAN_CRYPTO_SEEDBYTES

#define SPHINCS_LEVEL3_KEY_SIZE PQCLEAN_SPHINCSSHAKE192FSIMPLE_CLEAN_CRYPTO_SECRETKEYBYTES
#define SPHINCS_LEVEL3_PUB_KEY_SIZE PQCLEAN_SPHINCSSHAKE192FSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES
#define SPHINCS_LEVEL3_PRV_KEY_SIZE (SPHINCS_LEVEL3_PUB_KEY_SIZE + SPHINCS_LEVEL3_KEY_SIZE)
#define SPHINCS_LEVEL3_SEED_SIZE PQCLEAN_SPHINCSSHAKE192FSIMPLE_CLEAN_CRYPTO_SEEDBYTES

#define SPHINCS_LEVEL5_KEY_SIZE PQCLEAN_SPHINCSSHAKE256FSIMPLE_CLEAN_CRYPTO_SECRETKEYBYTES
#define SPHINCS_LEVEL5_PUB_KEY_SIZE PQCLEAN_SPHINCSSHAKE256FSIMPLE_CLEAN_CRYPTO_PUBLICKEYBYTES
#define SPHINCS_LEVEL5_PRV_KEY_SIZE (SPHINCS_LEVEL5_PUB_KEY_SIZE + SPHINCS_LEVEL5_KEY_SIZE)
#define SPHINCS_LEVEL5_SEED_SIZE PQCLEAN_SPHINCSSHAKE256FSIMPLE_CLEAN_CRYPTO_SEEDBYTES

#endif /* HAVE_LIBOQS */

#define SPHINCS_MAX_SEED_SIZE SPHINCS_LEVEL5_SEED_SIZE
...
#define SPHINCS_FAST_VARIANT 1
#define SPHINCS_SMALL_VARIANT 2
...
WOLFSSL_API int wc_Sphincs_PrivateKeyDecode(const byte *input, word32 *inOutIdx, sphincs_key *key,
                                            word32 inSz);
WOLFSSL_API int wc_Sphincs_PublicKeyDecode(const byte *input, word32 *inOutIdx, sphincs_key *key,
                                           word32 inSz);
WOLFSSL_API int wc_Sphincs_KeyToDer(sphincs_key *key, byte *output, word32 inLen);
WOLFSSL_API int wc_Sphincs_PrivateKeyToDer(sphincs_key *key, byte *output, word32 inLen);
WOLFSSL_API int wc_Sphincs_PublicKeyToDer(sphincs_key *key, byte *output, word32 inLen,
                                          int withAlg);
