...
#define FALCON_MAX_PUBKEY_SIZE FALCON_LEVEL5_PUBKEY_SIZE
#define FALCON_MAX_PRIVKEY_SIZE FALCON_LEVEL5_PRIVKEY_SIZE
...
struct falcon_key {
    ...
    byte p[FALCON_MAX_PUBKEY_SIZE];
    byte k[FALCON_MAX_PRIVKEY_SIZE];
};
