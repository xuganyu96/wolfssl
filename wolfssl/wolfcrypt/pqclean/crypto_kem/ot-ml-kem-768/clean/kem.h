#ifndef OTMLKEM768_CLEAN_KEM_H
#define OTMLKEM768_CLEAN_KEM_H
#include "params.h"
#include <stdint.h>
#include <wolfssl/wolfcrypt/random.h>

#define OTMLKEM768_CLEAN_CRYPTO_SECRETKEYBYTES KYBER_SECRETKEYBYTES
#define OTMLKEM768_CLEAN_CRYPTO_PUBLICKEYBYTES KYBER_PUBLICKEYBYTES
#define OTMLKEM768_CLEAN_CRYPTO_CIPHERTEXTBYTES KYBER_CIPHERTEXTBYTES
#define OTMLKEM768_CLEAN_CRYPTO_BYTES KYBER_SSBYTES
