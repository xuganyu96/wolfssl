...
#elif defined(PQCLEAN_DILITHIUM)
#define DILITHIUM_LEVEL2_KEY_SIZE PQCLEAN_MLDSA44_CLEAN_CRYPTO_SECRETKEYBYTES
#define DILITHIUM_LEVEL2_SIG_SIZE PQCLEAN_MLDSA44_CLEAN_CRYPTO_BYTES
#define DILITHIUM_LEVEL2_PUB_KEY_SIZE PQCLEAN_MLDSA44_CLEAN_CRYPTO_PUBLICKEYBYTES
#define DILITHIUM_LEVEL2_PRV_KEY_SIZE (DILITHIUM_LEVEL2_KEY_SIZE + DILITHIUM_LEVEL2_PUB_KEY_SIZE)
#define ML_DSA_LEVEL2_KEY_SIZE DILITHIUM_LEVEL2_KEY_SIZE
#define ML_DSA_LEVEL2_SIG_SIZE DILITHIUM_LEVEL2_SIG_SIZE
#define ML_DSA_LEVEL2_PUB_KEY_SIZE DILITHIUM_LEVEL2_PUB_KEY_SIZE
#define ML_DSA_LEVEL2_PRV_KEY_SIZE DILITHIUM_LEVEL2_PRV_KEY_SIZE

#define DILITHIUM_LEVEL3_KEY_SIZE PQCLEAN_MLDSA65_CLEAN_CRYPTO_SECRETKEYBYTES
#define DILITHIUM_LEVEL3_SIG_SIZE PQCLEAN_MLDSA65_CLEAN_CRYPTO_BYTES
#define DILITHIUM_LEVEL3_PUB_KEY_SIZE PQCLEAN_MLDSA65_CLEAN_CRYPTO_PUBLICKEYBYTES
#define DILITHIUM_LEVEL3_PRV_KEY_SIZE (DILITHIUM_LEVEL3_KEY_SIZE + DILITHIUM_LEVEL3_PUB_KEY_SIZE)
#define ML_DSA_LEVEL3_KEY_SIZE DILITHIUM_LEVEL3_KEY_SIZE
#define ML_DSA_LEVEL3_SIG_SIZE DILITHIUM_LEVEL3_SIG_SIZE
#define ML_DSA_LEVEL3_PUB_KEY_SIZE DILITHIUM_LEVEL3_PUB_KEY_SIZE
#define ML_DSA_LEVEL3_PRV_KEY_SIZE DILITHIUM_LEVEL3_PRV_KEY_SIZE

#define DILITHIUM_LEVEL5_KEY_SIZE PQCLEAN_MLDSA87_CLEAN_CRYPTO_SECRETKEYBYTES
#define DILITHIUM_LEVEL5_SIG_SIZE PQCLEAN_MLDSA87_CLEAN_CRYPTO_BYTES
#define DILITHIUM_LEVEL5_PUB_KEY_SIZE PQCLEAN_MLDSA87_CLEAN_CRYPTO_PUBLICKEYBYTES
#define DILITHIUM_LEVEL5_PRV_KEY_SIZE (DILITHIUM_LEVEL2_KEY_SIZE + DILITHIUM_LEVEL2_PUB_KEY_SIZE)
#define ML_DSA_LEVEL5_KEY_SIZE DILITHIUM_LEVEL5_KEY_SIZE
#define ML_DSA_LEVEL5_SIG_SIZE DILITHIUM_LEVEL5_SIG_SIZE
#define ML_DSA_LEVEL5_PUB_KEY_SIZE DILITHIUM_LEVEL5_PUB_KEY_SIZE
#define ML_DSA_LEVEL5_PRV_KEY_SIZE DILITHIUM_LEVEL5_PRV_KEY_SIZE
