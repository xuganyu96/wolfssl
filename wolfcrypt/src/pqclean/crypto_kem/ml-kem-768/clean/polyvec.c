 ...
 **************************************************/
void PQCLEAN_MLKEM768_CLEAN_polyvec_compress(uint8_t r[KYBER_POLYVECCOMPRESSEDBYTES],
                                             const polyvec *a) {
    unsigned int i, j, k;
    uint64_t d0;
 ...
 **************************************************/
void PQCLEAN_MLKEM768_CLEAN_polyvec_decompress(polyvec *r,
 ...
 **************************************************/
void PQCLEAN_MLKEM768_CLEAN_polyvec_basemul_acc_montgomery(poly *r, const polyvec *a,
                                                           const polyvec *b) {
    unsigned int i;
    poly t;
