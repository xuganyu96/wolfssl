...
#include <stdint.h>
#include <string.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ml-kem-768/clean/indcpa.h>
...
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ml-kem-768/clean/polyvec.h>
...
void PQCLEAN_MLKEM768_CLEAN_gen_matrix(polyvec *a, const uint8_t seed[KYBER_SYMBYTES],
                                       int transposed) {
