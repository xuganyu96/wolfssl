 ...
 **************************************************/
int OTMLKEM1024_CLEAN_verify(const uint8_t *a, const uint8_t *b, size_t len) {
    size_t i;
    uint8_t r = 0;
 ...
 **************************************************/
void OTMLKEM1024_CLEAN_cmov(uint8_t *r, const uint8_t *x, size_t len, uint8_t b) {
    size_t i;
...
/*************************************************
 * Name:        OTMLKEM1024_CLEAN_cmov_int16
 *
 ...
 *              uint8_t b:        Condition bit; has to be in {0,1}
 **************************************************/
void OTMLKEM1024_CLEAN_cmov_int16(int16_t *r, int16_t v, uint16_t b) {
    b = -b;
    *r ^= b & ((*r) ^ v);
}
