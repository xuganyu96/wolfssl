...
#include <stdint.h>
#include <string.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ml-kem-1024/clean/indcpa.h>
...
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ml-kem-1024/clean/polyvec.h>
...
void PQCLEAN_MLKEM1024_CLEAN_gen_matrix(polyvec *a, const uint8_t seed[KYBER_SYMBYTES],
                                        int transposed) {
