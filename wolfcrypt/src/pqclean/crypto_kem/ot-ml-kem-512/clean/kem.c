...
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ot-ml-kem-512/clean/kem.h>
...
/*************************************************
 * Name:        OTMLKEM512_CLEAN_crypto_kem_keypair_derand
 *
...
/*************************************************
 * Name:        OTMLKEM512_CLEAN_crypto_kem_keypair
 *
 * Description: Generates public and private key
 *              for CCA-secure Kyber key encapsulation mechanism
 *
...
int OTMLKEM512_CLEAN_crypto_kem_keypair(uint8_t *pk, uint8_t *sk, WC_RNG *rng) {
    ...
    OTMLKEM512_CLEAN_crypto_kem_keypair_derand(pk, sk, coins);
    return 0;
}

/*************************************************
 * Name:        OTMLKEM512_CLEAN_crypto_kem_enc_derand
 *
...
/*************************************************
 * Name:        OTMLKEM512_CLEAN_crypto_kem_enc
 *
 * Description: Generates cipher text and shared
 *              secret for given public key
 *
...
/*************************************************
 * Name:        OTMLKEM512_CLEAN_crypto_kem_dec
 *
