 ...
 */
void PQCLEAN_HQC256_CLEAN_vect_set_random_fixed_weight(seedexpander_state *ctx, uint64_t *v,
                                                       uint16_t weight) {
 ...
 * array of bytes using the PQCLEAN_HQC256_CLEAN_seedexpander function, and drop the extra bits
 * using a mask.
 *
 * @param[in] v Pointer to an array
 * @param[in] ctx Pointer to the context of the seed expander
 ...
 */
void PQCLEAN_HQC256_CLEAN_vect_add(uint64_t *o, const uint64_t *v1, const uint64_t *v2,
                                   size_t size) {
 ...
 */
void PQCLEAN_HQC256_CLEAN_vect_resize(uint64_t *o, uint32_t size_o, const uint64_t *v,
                                      uint32_t size_v) {
