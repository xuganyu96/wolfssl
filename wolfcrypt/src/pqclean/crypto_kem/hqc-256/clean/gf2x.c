...
static void karatsuba_add1(uint64_t *alh, uint64_t *blh, const uint64_t *a, const uint64_t *b,
                           size_t size_l, size_t size_h) {
...
static void karatsuba_add2(uint64_t *o, uint64_t *tmp1, const uint64_t *tmp2, size_t size_l,
                           size_t size_h) {
 ...
 */
static void karatsuba(uint64_t *o, const uint64_t *a, const uint64_t *b, size_t size,
                      uint64_t *stack) {
