...
#include <stdint.h>
#include <string.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ml-kem-512/clean/indcpa.h>
...
#include <wolfssl/wolfcrypt/pqclean/crypto_kem/ml-kem-512/clean/polyvec.h>
...
void PQCLEAN_MLKEM512_CLEAN_gen_matrix(polyvec *a, const uint8_t seed[KYBER_SYMBYTES],
                                       int transposed) {
