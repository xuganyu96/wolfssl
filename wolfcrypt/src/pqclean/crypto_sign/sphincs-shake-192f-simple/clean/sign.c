...
// #include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-192f-simple/clean/randombytes.h>
 ...
 */
int crypto_sign(uint8_t *sm, size_t *smlen, const uint8_t *m, size_t mlen, const uint8_t *sk, WC_RNG *rng) {
    size_t siglen;
