...
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/address.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/context.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/fors.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/hash.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/merkle.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/nistapi.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/params.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/thash.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/utils.h>
#include <wolfssl/wolfcrypt/pqclean/crypto_sign/sphincs-shake-128s-simple/clean/wots.h>
 ...
 */
size_t crypto_sign_publickeybytes(void) { return CRYPTO_PUBLICKEYBYTES; }

/*
 * Returns the length of a signature, in bytes
 */
size_t crypto_sign_bytes(void) { return CRYPTO_BYTES; }

/*
 * Returns the length of the seed required to generate a key pair, in bytes
 */
size_t crypto_sign_seedbytes(void) { return CRYPTO_SEEDBYTES; }
...
int crypto_sign(uint8_t *sm, size_t *smlen, const uint8_t *m, size_t mlen, const uint8_t *sk,
    ...
    crypto_sign_signature(sm, &siglen, m, mlen, sk, rng);
